...
title('Cumlative Importance of Feature Statistics')
...
title('Cumlative Importance of Strain Components')
ylabel('Sum of Importances');
...
title(append('Cumlative Importance of Top ',string(length(index(1:9))), ' Features' ))
ylabel('Sum of Importances');
%IMPORTANCE HERE IS VALUE OF NORMALIZED SHAPVALS
%ax = nexttile;

sgt = sgtitle('Cumlative SHAP Feature Importances');
sgt.FontSize = 18;
