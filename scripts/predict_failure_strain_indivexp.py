...
fold = '../strain_data_MS/'
out_str = fold.replace('strain_data_MS/', 'strain_pred_res2/')
score_txt = out_str+'strains_'+dim+'_'+mstr+'score_'+split_str+'_lim'+str(lim)+'.txt'
...
for exp in exps:
    print(exp)
    a = nois[ei]
    fname = fold+'strains_curr_'+exp+'_g'+rad+'0.txt'
